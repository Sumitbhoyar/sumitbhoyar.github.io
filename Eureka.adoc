...
i. Add dependency spring-cloud-starter-feign  

ii. Add @EnableFeignClients along with @EnableEurekaClient to @SpringBootApplication class.

iii. Create the client. It is similar to Spring data interfaces.
```java
...
```
iv. Call the client by injecting client.
